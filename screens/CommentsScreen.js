...
const CommentsScreen = (props) => {
    ...
    }, [props.route.params.postId, props.users]) //variable passed along with react navigation
    ...
    return (<View>
        ...
        <View>
            <TextInput style={{ marginTop: 40 }} placeholder="comment..." onChangeText={(comment) => setText(comment)} />
